...
CREATE TABLE `cc_cuenta_cliente` (
  ...
  `ESTADO` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'P: pendiente, C: cobrado, A: atendido (ficha de atencion creada);',
...
(8,10,5,1,1,'2022-05-24 12:00:00','1.000','1.000','Agendamiento para el 24/05/2022 a las 12:00.','A',1,'2022-05-23 10:46:32');
...
(5,1,'2022-05-24','2022-05-24 12:00:00',10,'','','',0,'','','P',1,'2022-05-23 10:46:32',NULL,0,'NO');
...
(1,3,6,14,'1','2','3','4','5','9','7','8','abc<br/>CD','cd','f<br/>g','g','iZA','zAB<br/>a<br/>bcd',1,'2022-04-04 11:18:56','A',1,NULL,'0000-00-00 00:00:00'),

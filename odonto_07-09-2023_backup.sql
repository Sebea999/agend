...
CREATE TABLE `ope_ficha_pac_nutri` (
  ...
  `MOTIVO_DE_LA_CONSULTA` varchar(500) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `ALIMENTOS_DE_PREFERENCIA` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `ALIMENTOS_QUE_NO_TOLERA` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `ALI_QUE_SUELE_COMER_GRL` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `CONSUMO_ALCOHOL` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `CONSUMO_CIGARRILLO` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `ALERGIAS_A_ALGO` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `CIRUGIAS` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `PADECE_ALGUNA_ENFERMEDAD` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `MEDICAMENTE_Q_E_CONSUMIENDO` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `OTROS_DATOS_A_TENER_EN_CUENTA` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `REALIZA_ACTIVIDAD_FISICA` int DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `TIPO_DE_ACTIVIDAD_FISICA` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  `FRECUENCIA_ACT_FISICA_SEM` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'DATOS REFERENTES A LA CONSULTA',
  ...
  `TDEDBU` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT 'CLASIFICACION DEL METABOLISMO (TIPO DE ESCALA DE BRISTOL USUAL)',
...
(38,0,0,9,'2023-07-18 13:44:00','Bajar de peso','le gusta mas lo salado','no le gusta el brocoli y es alergica al picante','desayuna cafe con leche, cena huevo','enalapril de 20mg 1 vez al dia','no suele tener hambre por la noche y si tiene busca algo dulce','socialmente','al cambio de clima','dejo hace 2 años','hipertensión','dos cesareas',1,'example','todos los dias',0,0,0,0,0,1,'6',1,1,1,1,2,2,2,2,2,'T','191','75','75','75','75','75','75','75','OMROM','','','','',1,'2023-07-18 13:45:53','A',1,'','2023-09-07 10:41:40'),
...
insert  into `ope_marca`(`IDMARCA`,`MARCA`,`ESTADO`,`USU_ALTA`,`FEC_ALTA`) values 
(2,'JEEP','A',NULL,NULL);
...
insert  into `users`(`idusuario`,`email`,`name`,`password`) values 
(1,'prueba@gmail.com','lorem ipsum','$2b$12$LSLFRAFfwMXnCnQwYC.x4eCvdL9PanngeQJZ59qVGHC.VbkP3IXy2'),
(2,'prueba6@gmail.com','prueba6','$2b$12$kDKjzcnavrvS7G9N/MdRLeCaDcHOI2s5PctjF.usz7ezahHbLflrS');

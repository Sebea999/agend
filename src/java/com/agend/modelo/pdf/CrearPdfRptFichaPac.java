...
public class CrearPdfRptFichaPac extends HttpServlet {
...
//                    idFactura = (String) sesionDatosUsuario.getAttribute("ID_FACTURA");
                    ...
                    System.out.println("[+] el id-paciente esta cargado: "+idPaciente);
                }
                
                
                // if para verificar y que no salte error en la creacion del PDF por si las variables devuelvan null o vacio y no se puedan recuperar datos de la db.-
                if (idFicha.isEmpty() || idPaciente.isEmpty()) {
                    System.out.println("[-] el idpaciente y el idficha se encuentran vacia...");
                    ...
                    System.out.println("[+] el idPaciente["+idPaciente+"] y idFicha["+idFicha+"] se encuentran con valores...");
                    documento.addTitle("Reporte de Ficha del Paciente");
                    String empresa = metodosIniSes.devolverEmpresa();
                    Paragraph titulo = new Paragraph(empresa, FontFactory.getFont("arial", 16, Font.BOLD));
                    titulo.setAlignment(1);
    ...
    //                TXT_CLIENTE_RUC = datosCliente.getRP_RUC();
                    ...
                    // value NAME_PACIENTE 
                    PdfPCell valuePaciente = new PdfPCell(new Phrase(TXT_PAC_NOM_APE, FontFactory.getFont("arial", fontSize11, Font.NORMAL)));
                    ...
                    // value FECHA/HORA 
                    PdfPCell valueFechaHora = new PdfPCell(new Phrase((TXT_FECHA_FICHA+" "+TXT_HORA_FICHA), FontFactory.getFont("arial", fontSize11, Font.NORMAL)));
                    ...
                    PdfPCell valueMotivoConsulta = new PdfPCell(new Phrase(TXT_MOTIVO_CONSULTA, FontFactory.getFont("arial", fontSize11, Font.NORMAL)));
                    ...
                    PdfPCell lblAlimentosPref = new PdfPCell(new Phrase("Alimentos de Preferencia: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblQueSueleComerGrl = new PdfPCell(new Phrase("Que suele comer generalmente: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblAlimentosNoTolera = new PdfPCell(new Phrase("Alimentos que no tolera o no le guste: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    // label RUC_CLIENTE 
                    PdfPCell lblRucCliente = new PdfPCell(new Phrase("Consumo Alcohol: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblConsumoCigarrillo = new PdfPCell(new Phrase("Consumo Cigarrillo: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblAlergias = new PdfPCell(new Phrase("Alergias a algo: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblEnfermedad = new PdfPCell(new Phrase("¿Padece alguna enfermedad? ¿Cuál?: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    // label CIRUGIAS 
                    PdfPCell lblCirugias = new PdfPCell(new Phrase("Cirugías: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblMedicamento = new PdfPCell(new Phrase("Medicamento y/o suplementación que este consumiendo: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
                    ...
                    PdfPCell lblOtrosDatos = new PdfPCell(new Phrase("Otros datos a tener en cuenta: ", FontFactory.getFont("arial", fontSize10, Font.BOLD)));
    ...
    //                documento.newPage();
                    ...
                    PdfPTable tablaBloque023 = new PdfPTable(4);
    //                PdfPTable tablaBloque023 = new PdfPTable(2);
                    tablaBloque023.getDefaultCell().setBorder(Rectangle.NO_BORDER);
                    tablaBloque023.setTotalWidth(650);
    //                tablaBloque023.setTotalWidth(550);
                    float[] medidaCeldaB023 = {250, 70, 250, 70};
    //                float[] medidaCeldaB023 = {250, 250};
                    tablaBloque023.setWidths(medidaCeldaB023);
                    tablaBloque023.setHorizontalAlignment(Element.ALIGN_LEFT);
                    ...
                    tablaBloque023.addCell(lblDigiereCarneRoja);
                    ...
                    tablaBloque023.addCell(valueDigiereCarneRoja);
                    ...
                    tablaBloque023.addCell(lblEstrenhimiento);
                    ...
                    tablaBloque023.addCell(valueEstrenhimiento);
                    ...
                    tablaBloque023.addCell(lblCalambresHormigueos);
                    ...
                    tablaBloque023.addCell(valueCalambreHormigueos);
                    ...
                    tablaBloque023.addCell(lblGrasasSaturadasCaeMal);
                    ...
                    tablaBloque023.addCell(valueGrasasSaturadasCaeMal);
                    ...
                    tablaBloque023.addCell(lblCansancioFatiga);
                    ...
                    tablaBloque023.addCell(valueCansancioFatiga);
                    // label ZUMBIDOS_OIDO 
                    ...
                    tablaBloque023.addCell(lblZumbidosEnElOido);
                    // value ZUMBIDOS_OIDO 
                    ...
                    tablaBloque023.addCell(valueZumbidosEnElOido);
                    ...
                    tablaBloque023.addCell(lblTieneBuenaDigestion);
                    ...
                    tablaBloque023.addCell(valueTieneBuenaDigestion);
                    ...
                    tablaBloque023.addCell(lblHinchazonAbdominal);
                    ...
                    tablaBloque023.addCell(valueHinchanzonAbdominal);
                    ...
                    tablaBloque023.addCell(lblCaidaDelCabello);
                    ...
                    tablaBloque023.addCell(valueCaidaDelCabello);
                    ...
                    tablaBloque023.addCell(lblDuermeProfundamente);
                    ...
                    tablaBloque023.addCell(valueDuermeProfundamente);
                    ...
                    tablaBloque023.addCell(lblUnhasQuebradizas);
                    ...
                    tablaBloque023.addCell(valueUnhasQuebradizas);
                    ...
                    tablaBloque023.addCell(lblDoloresCabFrec);
                    ...
                    tablaBloque023.addCell(valueDoloresCabFrec);
                    ...
                    tablaBloque023.addCell(lblMucosidadCatarro);
                    ...
                    tablaBloque023.addCell(valueMucosidadCatarro);
                    // label PIEL_SECA 
                    ...
                    tablaBloque023.addCell(lblPielSeca);
                    // value PIEL_SECA 
                    ...
                    tablaBloque023.addCell(valuePielSeca);
                    // label METABOLISMO 
                    ...
                    tablaBloque023.addCell(lblMetabolismo);
                    // value METABOLISMO 
                    ...
                    tablaBloque023.addCell(valueMetabolismo);
                    ...
                    tablaBloque023.addCell(lblTipoEscalaBristol);
                    ...
                    tablaBloque023.addCell(valueTipoEscalaBristol);
                    // CARGO LA TABLA AL DOCUMENTO.-
                    tablaBloque023.setSpacingBefore(15);
                    documento.add(tablaBloque023);
    ...
    //                documento.add(tablaTotales);
                } // end-if-verify-idPaciente-and-idFicha.-

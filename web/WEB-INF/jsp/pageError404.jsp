<%-- 
    Document   : pageError404
    Created on : 09-nov-2021, 14:06:33
    Author     : RYUU
--%>
                ...
                <%
                    /*
                        * DETALLES DE LOS ERRORES: 
                        ...
                        https://www.webempresa.com/blog/paginas-error-htaccess-personalizalas.html
                    */
...
//                        System.out.println(".");System.out.println(".");System.out.println(".");
                %>
                <h1 class="FEP" <%//style="font-weight: 700; font-size: 4rem; margin: auto; color: #007bff; text-align: center;"%>>404</h1>
                <h3>No se encontro la página solicitada.</h3>
                <h4>Verifique si la url es correcta.</h4>
            </main>

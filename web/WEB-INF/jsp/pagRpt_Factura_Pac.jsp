                        ...
                        <table role="table" class="tableFilterRF">
                            <thead role="rowgroup">
                                <tr role="row">
                                    ...
                                    <td role="columnheader" class="RF_CE">Tipo Factura</td>
                            ...
                            <tbody role="rowgroup">
                                <%
                                    ...
                                    if (((List<BeanFacturaCab>)request.getAttribute("CR_RF_LISTA_FILTRO")) != null) { // si se hace el filtro entonces en la lista se debe almacenar del resultado que le pasamos 
                                        ...
                                        listaDatos = metodosFactura.cargar_grilla_paginacion_rtp_fact(sesionDatosUsuario, NRO_PAG, cant_min_fija, idPersona);
                                    ...
                                    while(iterDatos.hasNext()) {
                                        ...
                                        String VAR_TIPO_FACTURA = datosBean.getOF_TIPOFACTURA();
                                        if ((VAR_TIPO_FACTURA == null) == false || (VAR_TIPO_FACTURA.isEmpty()) == false) {
                                            if (VAR_TIPO_FACTURA.equalsIgnoreCase("Cr")) {
                                                VAR_TIPO_FACTURA = "Crédito";
                                            } else if (VAR_TIPO_FACTURA.equalsIgnoreCase("Co")) {
                                                VAR_TIPO_FACTURA = "Contado";
                                            } else {
                                                VAR_TIPO_FACTURA = datosBean.getOF_TIPOFACTURA();
                                            }
                                        }
                                %>
                                <tr role="row">

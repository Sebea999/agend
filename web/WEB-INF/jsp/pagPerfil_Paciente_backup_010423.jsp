<%-- 
    Document   : pagPerfil_Paciente
    Created on : 12-abr-2022, 13:05:34
    Author     : RYUU
--%>
        ...
        <%@include file="menu_jsp.jsp" %> <% // INCLUYO EL MENU %>
            ...
            %>
                <div class="content-over">
                    ...
                    String PAC_DESC_CIUDAD="", PAC_NOMBRE="", PAC_APELLIDO="", PAC_CINRO="", PAC_RAZON_SOCIAL="", PAC_RUC="", PAC_TELEFONO="", PAC_DIRECCION="", PAC_EMAIL="", PAC_IDUSUARIO="", PAC_USUARIO="", PAC_CLAVE="", PAC_ESTADO="", PAC_FECHA_NAC="", PAC_SEXO="", PAC_IDCLINICA="", PAC_SEGURO_MEDICO="", PAC_OCUPACION="", PAC_ANTECEDENTES_FAMILIARES="";
                    String PAC_ESTADO_CIVIL="", PAC_CELULAR="", PAC_TIENE_HIJOS="", PAC_CANT_HIJOS="";
...
<%--                            <div class="antec-fam">
                                ...
                                <div class="datosPacBtn">
                                    ...
                                    */
                                    ...
                                    %>
                                    <input type="hidden" value="<%= ID_PACIENTE %>" name="tI" class="form-control"/>
                                    <input type="submit" value="Imprimir" name="accion" class="btn btn-outline-danger btnAnteImpr"/>
                            ...
                            <table role="table" class="tableFicAte">
                                <thead role="rowgroup">
                                    <tr role="row">
                                        ...
                                        <td role="columnheader" class="PFA_CMC">MOTIVO DE LA CONSULTA</td>
                                ...
                                <tbody role="rowgroup">
                                    <%
                                        ...
                                        System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".       _____PERFIL_PACIENTE_______");
...
//                                            datosBPersona = metodosPersona.datosBasicosPersona(datosBPersona, datosBeanDet.getOAP_IDPACIENTE());
                                    ...
                                    <tr role="row">
                                        ...
                                        <td role="cell" class="PFA_CA">
                                            ...
                                            <button type="submit" name="accion" value="Ver Atención" class="<%=BTN_CSS%>"><%=BTN_NAME%></button>
                                            <%
...
//                                            }
                        ...
                        <div class="ml-4">
                            <a href="<%= urlPrincipal %>" class="btn btn-danger">Volver al Menú</a>
                        </div>
                    </div>
                </div>
            </main>

...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/css/stylePagCab12.css">
    </head>
    <body>
...
//                }
            %>
                <div class="contentAAS" style="/*border:1px solid red;*/">
                    <div>
                            ...
                            <div class="col-11 pac_panel">
                                ...
                                <div class="pac_panel_1">
                                    ...
                                    <div class="pac_panel_3">
                                        ...
                                        <% // -- BUTTON MODAL -- %>
                                        <input type="submit" value="Ver Horario del Médico" name="accion" class="btn btn-info w-50 ml-2 text-white"/>
                                    </div>
                                </div>
                                <div class="pac_panel_1">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', ()=> {
               document.querySelectorAll('input[type=text]').forEach( node => node.addEventListener('keypress', e => {
                   if (e.keyCode == 13) {
                       console.log("evento de enter - if -");
                       e.preventDefault();

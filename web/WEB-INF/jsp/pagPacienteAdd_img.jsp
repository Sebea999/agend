...
//                    String SEGUNDO_MENSAJE="";
//                    if ((sesionDatosUsuario.getAttribute("CP_PAC_SEGUNDO_MENSAJE") == null) == false) {
//                        SEGUNDO_MENSAJE = (String) sesionDatosUsuario.getAttribute("CP_PAC_SEGUNDO_MENSAJE");
...
//                        sesionDatosUsuario.removeAttribute("CP_PAC_SEGUNDO_MENSAJE");
//                    }
...
<%--                                    </div>
                                ...
                                <div class="pac_panel_1">
                                    <div class="pac_panel_2">
                                        <label for="fichaFile" class="form-label mr-2 pt-1">Imagen:</label>
                                    </div>
                                    <div class="pac_panel_3">
                                        <input type="file" name="PacFile" id="PacFile" class="form-control form-control-file">
                                    </div>
                                    <%
                                        // VARIABLE QUE USO COMO BANDERA PARA EL CONTROLADOR Y ASI SABER CUANDO EDITAR LA IMAGEN O NO.-
//                                        int bandImg = 0;
                                        System.out.println(".");
                                        System.out.println(".");System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".   _____________JSP_______________");
                                        System.out.println(".   __FOTO: :"+PAC_FOTO);
                                        System.out.println(".   __FOTO:ABS: :"+PAC_FOTO_ABS);
                                        System.out.println(".");System.out.println(".");
                                        System.out.println(".");
                                    if (PAC_FOTO == null || PAC_FOTO.isEmpty() || PAC_FOTO.equals("")) {
                                        System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".____JSP____");
                                        System.out.println(".__IF_________________FOTO_________________");
                                    } else {
                                        System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".");
                                        System.out.println(".____JSP____");
                                        System.out.println("__ELSE________FOTO____JSP_ADD_____");
                                        System.out.println("____FOTO: :"+PAC_FOTO);
//                                        bandImg = 1; // COMO LA DIRECCION DE LA IMAGEN NO SE ENCUENTRA VACIA ENTONCES CAMBIO EL VALOR DE LA BANDERA 
                                        String s = File.separator;
                                        String idpac;
                                        if (PAC_FOTO_ABS.contains(ID_PACIENTE)) {
                                            System.out.println("___IF_____ID_PACIENTE_____"+ID_PACIENTE);
                                            idpac = ID_PACIENTE+s;
                                        } else {
                                            System.out.println("___ELSE______ID_PACIENTE______"+ID_PACIENTE);
                                            idpac = "";
                                        }
                                        File fileFoto = new File(PAC_FOTO_ABS);
                                        
                                        String img = "/recursos/static/"+fileFoto.getName();
//                                        String img = "recursos"+s+"static"+s+fileFoto.getName(); // [OBS] :ruta correcta pero agregando las barras laterales segun el sistema-operativo, pero le agrego en duro y comento esta para poder tener la ruta igual a la que especifique en la etiqueta <mvc:resources> en el dispatcher-serlvet.-
//                                        String img = "recursos"+s+"static"+s+idpac+fileFoto.getName();// [OBS] COMENTE EL CODIGO QUE CREA UNA SUBCARPETA EN LA CARPETA STATIC CON EL IDPACIENTE COMO NOMBRE PARA EVITAR PROBLEMAS ENTRE IMAGENES PERO ME ESTABA DANDO PROBLEMAS ENTONCES LO COMENTE.-
//                                        String img = "http:"+s+s+"localhost:9090"+s+"agend"+s+"recursos"+s+"static"+s+idpac+fileFoto.getName();
//                                        String img = "http://localhost:9090/agend/recursos/static/"+fileFoto.getName();
                                    %>
                                    <div class="pac_panel_3">
                                        <img src="<c:url value="<%=img%>" />" id="loadImg" width="600" height="400" alt=""/>
                                        <!--<img src="<%--= img --%>" id="loadImg" width="600" height="400" alt=""/>-->
                                    </div>
                                    <%
                                    }
                                    %>
                                    <input type="hidden" value="<%= PAC_FOTO %>" name="TAPI" class="form-control disNone">
                                    <input type="hidden" value="<%= PAC_FOTO_ABS %>" name="TAPIPA" class="form-control disNone">
                                    <div class="pac_panel_3">
                                        <div id="preview" class="styleImage disNone">
                                            <img src="" id="previewImg" width="600" height="400" alt=""/>
                                        </div>
                                    </div>
                                </div>

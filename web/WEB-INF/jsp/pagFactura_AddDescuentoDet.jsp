<%-- 
    Document   : pagFactura_AddDescuentoDet
    Created on : 07-oct-2021, 12:24:12
    Author     : RYUU
--%>
    ...
    <body>
        <%@include file="menu_jsp.jsp" %> <% // INCLUYO EL MENU %>
            <main>
                ...
                String mensaje = (String) request.getAttribute("CF_CD_MENSAJE"); // CONTROLLER FACTURA CARGAR DESCUENTO MENSAJE 
                String tipoMensaje = (String) request.getAttribute("CF_CD_TIPO_MENSAJE"); // CONTROLLER FACTURA CARGAR DESCUENTO TIPO MENSAJE 
                String claseMensaje = "";
            ...
            %>
                ...
                <div>
                    <h4 class="mainTitle">Crear Factura / Cargar Descuento</h4>
                </div>
                <%
                    ...
                    String TXT_DESCRIPCION_INTERES = (String) request.getAttribute("CF_FCD_TXT_DESCRIPCION");
                    if (TXT_DESCRIPCION_INTERES == null) {
                        TXT_DESCRIPCION_INTERES = "";
                    }
                    String CBX_IVA = (String) request.getAttribute("CF_FCD_CBX_IVA");
                    String TXT_PRECIO = (String) request.getAttribute("CF_FCD_TXT_PRECIO");
                    if (TXT_PRECIO == null) {
                        TXT_PRECIO = "";
                    }
                %>
                <div class="boxFCP">
                    ...
                    <div class="boxFCP1 panelBtn">
                        <input type="submit" value="Cargar Descuento a la Lista" name="accionFCD" class="btn btn-info mr-2" />
                        <a href="javascript:limpiarFADD()" class="btn btn-info">Limpiar</a>
                    </div>
                                ...
                                <tr role="row">
                                    ...
                                    <td role="cell" class="FCPCE">
                                        <form action="CFSrv" method="post">
                                            ...
                                            <input type="submit" value="Eliminar" name="accionFCD" class="btn btn-danger" />
                                        </form>
                                    </td>
                                </tr>
                                <%
                ...
                <div class="boxBtnCtaCli">
                    <form method="post" action="CFSrv"> <% // COLOCAR ESTE FORM ACA, AYUDA A QUE SE OBTENGAN CORRECTAMENTE LOS DATOS DE ESTOS CAMPOS DE TEXTOS EN LOS EVENTOS DE LOS DOS BOTONES (SI NO ESTA, PUEDE OBTENER MAL EL DATO TRAYENDO EL DATO DE OTRO CAMPO DE TEXTO) %>
                        ...
                        <input type="submit" value="Cargar Detalle" name="accionFCD" class="btn btn-primary mt-2" />
                    </form>
                </div>
                </form>
            </main>

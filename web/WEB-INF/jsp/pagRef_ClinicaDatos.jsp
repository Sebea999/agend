    ...
    <body>
        <%@include file="menu_jsp.jsp" %> <% // INCLUYO EL MENU %>
            <main>
                ...
                String mensaje = (String) request.getAttribute("CRC_MENSAJE"); // CONTROLLER REFERENCIA CLINICA MENSAJE 
                String tipoMensaje = (String) request.getAttribute("CRC_TIPO_MENSAJE"); // CONTROLLER REFERENCIA CLINICA TIPO MENSAJE 
                String claseMensaje = "";
                ...
                */
                String ID_CLINICA = (String) sesionDatosUsuario.getAttribute("ID_CLINICA");
                System.out.println("_jsp___ID_CLINICA:  "+ID_CLINICA);
                
                List<BeanClinica> listaDatos;
                listaDatos = metodosClinica.traer_datos(ID_CLINICA, sesionDatosUsuario);
                Iterator<BeanClinica> iterClinica = listaDatos.iterator();
                BeanClinica clinica_bean = null;
                // VARIABLES QUE REPRESENTAN LAS COLUMNAS DE LA TABLA  
                String CLI_DESCRIPCION="", CLI_DIRECCION="", CLI_TELEFONO="0", CLI_EMAIL="", CLI_ESTADO="A";
                String CLI_DESCRIPCION_ORI="", CLI_DIRECCION_ORI="", CLI_TELEFONO_ORI="", CLI_EMAIL_ORI="";
                
                while(iterClinica.hasNext()) {
                    clinica_bean = iterClinica.next();
                    CLI_DESCRIPCION = clinica_bean.getOC_DESC_CLINICA();
                    CLI_DIRECCION = clinica_bean.getOC_DIRECCION();
                    CLI_TELEFONO = clinica_bean.getOC_TELEFONO();
                    CLI_EMAIL = clinica_bean.getOC_EMAIL();
                    CLI_ESTADO = clinica_bean.getOC_ESTADO();
                    // CARGO LAS VARIABLES QUE UTILIZARE CUANDO SE DE CLICK AL BOTON DE CANCELAR 
                    CLI_DESCRIPCION_ORI = clinica_bean.getOC_DESC_CLINICA();
                    CLI_DIRECCION_ORI = clinica_bean.getOC_DIRECCION();
                    CLI_TELEFONO_ORI = clinica_bean.getOC_TELEFONO();
                    CLI_EMAIL_ORI = clinica_bean.getOC_EMAIL();
                } // end while 
                ...
                if ((String)request.getAttribute("CRC_CLINICA_DESC") != null) {
                    CLI_DESCRIPCION = (String) request.getAttribute("CRC_CLINICA_DESC");
                }
                if ((String)request.getAttribute("CRC_DIRECCION") != null) {
                    CLI_DIRECCION = (String) request.getAttribute("CRC_DIRECCION");
                }
                if ((String)request.getAttribute("CRC_TELEFONO") != null) {
                    CLI_TELEFONO = (String) request.getAttribute("CRC_TELEFONO");
                }
                if ((String)request.getAttribute("CRC_EMAIL") != null) {
                    CLI_EMAIL = (String) request.getAttribute("CRC_EMAIL");
                }
                if ((String)request.getAttribute("CRC_ESTADO") != null) {
                    CLI_ESTADO = (String) request.getAttribute("CRC_ESTADO");
                }
                ...
                if (ID_CLINICA.isEmpty() || ID_CLINICA.equals("")) {
                    varTitulo = "CLINICA - NUEVO REGISTRO";
                    btnName = "GRABAR";
                    btnCss = "btn btn-primary";
                } else {
                    varTitulo = "CLINICA - MODIFICAR REGISTRO";
                    btnName = "MODIFICAR";
                    ...
                    <div class="divTableData">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>CÓDIGO:</td>
                                <td>
                                    <input type="text" value="<%= ID_CLINICA %>" readonly="readonly" class="form-control" />
                                </td>
                            </tr>
                            <tr>
                                <td>Descripción:</td>
                                <td>
                                    <input type="text" value="<%= CLI_DESCRIPCION %>" id="tDC" name="tDC" class="form-control" />
                                </td>
                            </tr>
                            <tr>
                                <td>Direccion: </td>
                                <td>
                                    <input type="text" value="<%= CLI_DIRECCION %>" id="tD" name="tD" class="form-control" />
                                </td>
                            </tr>
                            <tr>
                                <td>Telefono: </td>
                                <td>
                                    <input type="text" value="<%= CLI_TELEFONO %>" id="tT" name="tT" class="form-control" />
                                </td>
                            </tr>
                            <tr>
                                <td>Email: </td>
                                <td>
                                    <input type="text" value="<%= CLI_EMAIL %>" id="tE" name="tE" class="form-control" />
                                </td>
                            </tr>
                            <tr>
                                <td>Estado:</td>
                                <td>
                                    <select class="form-control" id="cE" name="cE">
                                        ...
                                        listaEstado = metodosIniSes.cargarComboEstado(CLI_ESTADO);
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    */
                                    ...
                                    String btnReqEliminar = (String) request.getAttribute("CLI_BTN_ELIMINAR");
                                    ...
                                    <%
                                        ...
                                        if(varEliminar > 0) {
                                    %>
                                        <input type="hidden" value="<%= ID_CLINICA %>" name="tI" class="form-control disNone" />
                                    ...
                                    System.out.println(".");System.out.println(".");System.out.println(".");
                                    %>
                                    <a href="<%= urlRefClinica %>" class="btn btn-danger">VOLVER</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <script type="text/javascript">
            function cancelar() {
                document.getElementById("tDC").value = "<%= CLI_DESCRIPCION_ORI %>";
                document.getElementById("tD").value = "<%= CLI_DIRECCION_ORI %>";
                document.getElementById("tT").value = "<%= CLI_TELEFONO_ORI %>";
                document.getElementById("tE").value = "<%= CLI_EMAIL_ORI %>";

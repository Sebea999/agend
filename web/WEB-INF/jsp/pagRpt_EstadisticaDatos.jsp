    ...
    <!--                                        <td role="cell" class="HFA_CA">
                                ...
                                <td role="cell" class="HFA_CA">
                                    ...
                                    <%
                                        ...
                                        System.out.println(".");
                                    %>
                                    <span class="d-flex flex-row justify-content-center align-content-center btn-file-linked">
                                        <i class="pt-1 iconSize12pt fa-solid fa-paperclip mr-2"></i>Con Archivo Adjunto
                                    </span>
                                    <%
                                    } // end-if-exits-det.-
                                    %>
                    ...
                    <div class="mt-3">
                        <form method="post" action="CRSrv" class="d-flex justify-content-around flex-wrap">
                ...
                %>
<!--                <div style="border: 1px solid red;" class="mt-3 mb-4">
                    <a href="#" onclick="downloadPDF()" id="downloadPdf" class="btn btn-outline-secondary">Descargar Gráfico en PDF</a>
                </div>-->
                <div class="d-flex flex-row align-items-center mb-4 justify-content-around">
                    <label for="RECTG" class="form-label pt-1 mr-2">Descargar el Gráfico de:</label>
                    <div>
                        <select style="width: 300px;" id="RECTG" name="RECTG" class="form-control">
                            <%
                            Map<String, String> cbxTipoGraf = new LinkedHashMap();
                            cbxTipoGraf = metodosFichaAtencionPacNutri.cargarComboTipoGraf(""); 
                            Set setListTG = cbxTipoGraf.entrySet();
                            Iterator iListTG = setListTG.iterator();
                            while(iListTG.hasNext()) {
                                Map.Entry mapSelec = (Map.Entry) iListTG.next();
                            %>
                            <option value="<%= mapSelec.getKey() %>"><%= mapSelec.getValue() %></option>
                            <%
                                }
                    ...
                    <a href="#" onclick="downloadPDF()" id="downloadPdf" class="btn btn-secondary ml-3">Descargar Gráfico en PDF</a>
                </div>
...
//        const myChart = new Chart(document.getElementById('estPeso'), config);
        ...
        function downloadPDF() {
            let tipoGraf = document.getElementById('RECTG').value;
            console.log('* TIPO_DE_GRAFICO:   :'+tipoGraf);
            const canvas = document.getElementById(tipoGraf);
//            const canvas = document.getElementById('estPeso');
            ...
            pdf.text(15, 15, "Reporte de Estadística");
            pdf.save();
        }

...
<!--                                <div class="pac_panel_1">
                                ...
                                <div class="pac_panel_1">
                                    ...
                                    <div class="pac_panel_3">
                                        <select class="form-control" id="cPHT" name="cPHT">
                                            <%
                                ...
                                <div class="pac_panel_1">
                                    ...
                                    <div class="pac_panel_3">
                                        <input type="text" value="<%= PH_DIA %>" id="tPHD" name="tPHD" class="form-control" />
                                    </div>
                                </div>
                                <div class="pac_panel_1">
                                ...
                                <div class="pac_panel_btns">
                                    ...
                                    <a href="<%= urlPaciente %>" class="btn btn-danger">VOLVER</a>
                                </div>
                            </div>
                        </form>
                    </div>

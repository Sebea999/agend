...
//                List<BeanPersona> listaDatos;
                String AGEN_FECHA="", AGEN_HORA="", AGEN_IDMEDICO="", AGEN_IDESPECIALIDAD="", AGEN_ESTADO="", AGEN_MOTIVO_CONSULTA="";
                    ...
                    <div class="divTableData mt-1">
                        <form action="CASrv" method="post" autocomplete="off">
                            <div class="col-11 pac_panel">
                                ...
                                <div class="pac_panel_1">
                                    <div class="pac_panel_2">Medico:</div>
                                    <div class="pac_panel_3">
...
//                                </div>-->%>
                                ...
                                <div class="pac_panel_btns mt-5">
                                    <input type="submit" name="accion" value="AGENDAR" class="btn btn-outline-primary" />
                                    <a href="<%= urlAgendamiento %>" class="btn btn-primary">LIMPIAR</a>
                                    <a href="<%= urlPrincipal %>" class="btn btn-danger">CANCELAR</a>
                                </div>
                            </div>
                        </form>
                    </div>

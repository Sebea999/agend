<%-- 
    Document   : pageError400
    Created on : 10-nov-2021, 9:50:27
    Author     : RYUU
--%>
...
//                        System.out.println(".");System.out.println(".");System.out.println(".");
                %>
                <h1 class="FEP">400</h1>
                <h3>El servidor no pudo entender la solicitud debido a un formato incorrecto de sintaxis. El cliente NO DEBE repetir la solicitud sin modificaciones.</h3>
            </main>
